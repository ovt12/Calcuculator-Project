...
//   headerOne.innerHTML = 0;
// });

// // ADDS ONE INTO H1 TAG
// oneSymbol.addEventListener("click", () => {
//   let oneSymbol = 1;
//   headerOne.innerHTML = headerOne.innerHTML + oneSymbol;
// });

// // ADDS TWO INTO H1 TAG
// twoSymbol.addEventListener("click", () => {
//   let twoSymbol = 2;
//   headerOne.innerHTML = headerOne.innerHTML + twoSymbol;
// });

// // ITERATES OF H1 ADDS NUMBER TO VARIABLE TO DISPLAY TO H1
